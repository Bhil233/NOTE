...
# 树莓派基本操作
	...
	安装miniconda
	下载：wget https://repo.anaconda.com/miniconda/Miniconda3-py311_25.9.1-3-Linux-aarch64.sh
	安装：sh Miniconda3-py311_25.9.1-3-Linux-aarch64.sh
	清除安装包：rm Miniconda3-py311_25.9.1-3-Linux-aarch64.sh
	激活：
	nano ~/.bashrc
	export PATH="/home/bhil/miniconda3/bin:$PATH" ctrl+o保存，再ctrl+x退出
	source ~/.bashrc
